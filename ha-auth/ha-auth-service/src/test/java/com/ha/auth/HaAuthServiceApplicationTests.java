...
@SpringBootTest
public class HaAuthServiceApplicationTests {
    ...
    public void testClient(){
        ...
        ServiceInstance serviceInstance = loadBalancerClient.choose("ha-auth");
        //此地址就是http://ip:port
    ...
    public void name() {
        String httpBasic = getHttpBasic("XcWebApp", "XcWebApp");
        JWT token = authServiceClient.getToken(httpBasic, "password","itcast", "111111");
