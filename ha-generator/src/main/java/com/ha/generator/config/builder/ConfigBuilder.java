package com.ha.generator.config.builder;

import com.ha.generator.common.*;
import com.ha.generator.config.*;
import com.ha.generator.config.po.TableField;
import com.ha.generator.config.po.TableFill;
import com.ha.generator.config.po.TableInfo;
import com.ha.generator.config.querys.H2Query;
import com.ha.generator.config.rules.NamingStrategy;
import lombok.Data;
...
public class ConfigBuilder {
    ...
    private void handlerPackage(TemplateConfig template, String outputDir, PackageConfig config) {
        ...
        if (configPathInfo != null) {
            ...
            /*if (!OthersUtils.isEmpty(template.getMapper())) {
                pathInfo.setMapper(joinPath(outputDir, packageInfo.getMapperXml()));
            }*/
    ...
    private TableInfo convertTableFields(TableInfo tableInfo, NamingStrategy strategy) {
        ...
        List<com.ha.generator.config.po.TableField> fieldList = new ArrayList<>();
        List<com.ha.generator.config.po.TableField> commonFieldList = new ArrayList<>();
        ...
        try {
            ...
            try (
                    ...
                    ResultSet results = preparedStatement.executeQuery()) {
                while (results.next()) {
                    com.ha.generator.config.po.TableField field = new TableField();
